...
<body style="background-image:url(coin.jpg);background-repeat: no-repeat;background-size: cover;background-blend-mode:hard-light; ">
<link rel = "stylesheet" type = "text/css" href = "style.css">
    ...
    <h1 style="color:wheat;text-align: center;font-family: 'Josefin Sans', sans-serif;" >Transaction History</h1>
